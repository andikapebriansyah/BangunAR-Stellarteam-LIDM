...
export default function BuildChallengeSelection() {
  ...
  const challenges = [
    ...
    },
    {
      id: 'mercusuar',
      title: 'Mercusuar',
      subtitle: '5 menit • 3 bentuk',
      difficulty: 'MUDAH',
      description: 'Bangun mercusuar sederhana menggunakan tabung untuk badan, kubus dan kerucut untuk atap',
      shapes: ['Tabung', 'Kubus', 'Kerucut'],
      image: '🚨',
    ...
    },
    {
      ...
      shapes: ['Kubus', 'Balok', 'Limas', 'Kerucut', 'Tabung'],
      image: '🏰',
